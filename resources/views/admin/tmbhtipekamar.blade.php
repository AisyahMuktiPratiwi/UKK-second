...
<div class="card" style="color:darkviolet;box-shadow: rgb(219, 217, 251) 5px 6px 12px;">
    <div class="card-body">
        <h1 style="text-align:center;font-family: 'Quintessential', cursive;"><b>Tambah Tipe Kamar</b></h1>
    </div>
</div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <button type="submit"
                        style="background-color:darkviolet;color:white;margin-top:2rem;">Simpan</button>
                </div>
            </div>
        </form>
    </div>
