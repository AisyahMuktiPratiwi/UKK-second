    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:rgb(170, 149, 228);">
        <div class="container">
            <a class="navbar-brand" href="/"><img src="{{ asset('image/logo5.png') }}" width="50" height="48"><span
                    style="font-family: 'Fredericka the Great', cursive;color:white;font-size:25px;margin-left:4%"><b>Hotel
                        Hebat</b></span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId" style="right:0">


                <ul class="navbar-nav me-auto mt-2 mt-lg-0" style="margin-left:120px">
                ...
                <ul class="navbar-nav me-auto mt-2 mt-lg-0" style="margin-left:110px">
                    <li class="nav-item">
